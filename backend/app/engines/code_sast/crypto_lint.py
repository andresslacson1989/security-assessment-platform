    ...
    for dirpath, dirnames, filenames in os.walk(root):
        ...
        for filename in filenames:
            ...
            try:
                ...
                read_errors += 1
                if emit_log:
                    await emit_log(LogLevel.WARNING, f"Crypto linter could not read '{rel_path}': {type(exc).__name__}")

    if emit_log and read_errors:
        await emit_log(LogLevel.WARNING, f"Crypto linter skipped {read_errors} files; coverage is degraded.")
