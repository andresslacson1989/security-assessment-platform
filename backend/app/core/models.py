...
class AuditAction(str, Enum):
    ...
    SCAN_AUTHORIZATION_REVOKED = "SCAN_AUTHORIZATION_REVOKED"
    SCAN_AUTHORIZATION_EXPIRED = "SCAN_AUTHORIZATION_EXPIRED"
    SCAN_AUTHORIZATION_CONSUMED = "SCAN_AUTHORIZATION_CONSUMED"
