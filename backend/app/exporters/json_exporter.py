...
import json
from app.core.models import ScanJob, mask_secret, sanitize_sensitive_data
...
def export_scan_to_json(scan_job: ScanJob) -> str:
    ...
    """
    data = scan_job.model_dump(mode="json")
    if "findings" in data:
    ...
    return json.dumps(sanitize_sensitive_data(data), indent=2)
