...
| [`07_FRONTEND_UI_UX_SPECIFICATION_CONTRACT.md`](./07_FRONTEND_UI_UX_SPECIFICATION_CONTRACT.md) | **Frontend UI/UX & Design System** (v14.0.0) | Cyber SOC Dark Theme tokens, HUD component hierarchy, real-time log terminal streamer, tool management matrix, SBOM export toolbar, and SSE protocol manager. |
| [`08_TECHNICAL_IMPLEMENTATION_AND_TEST_VECTORS_CONTRACT.md`](./08_TECHNICAL_IMPLEMENTATION_AND_TEST_VECTORS_CONTRACT.md) | **Technical Implementation & Test Vectors** (v14.0.0) | Exact execution algorithms, binary discovery, mock test vectors, production multi-stage Dockerfile, and GitHub Actions CI/CD publishing pipeline. |
| [`09_TOOL_IMPLEMENTATION_CONTRACT.md`](./09_TOOL_IMPLEMENTATION_CONTRACT.md) | **Tool Implementation Contract & Execution Specifications** (v14.0.0) | Authoritative 41-point implementation specifications for all 21 external security tools, invocation boundaries, failure semantics, output schemas, and security controls. |
