...
| [`05_DELIVERABLES_AND_ACCEPTANCE_CRITERIA_CONTRACT.md`](./05_DELIVERABLES_AND_ACCEPTANCE_CRITERIA_CONTRACT.md) | **Deliverables & Acceptance Criteria** | Deliverables checklist, 8 concrete acceptance test scenarios, and strict Definition of Done (DoD). |
