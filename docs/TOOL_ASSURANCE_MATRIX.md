...
- **Acceptance evidence**: The current full repository regression completed with `453 passed, 4 skipped, 3 warnings`; E12 managed-runtime probes also passed in the production image. FFuF and Nuclei launches are explicitly blocked at engine and adapter boundaries when tenant active-probing authorization is absent.
