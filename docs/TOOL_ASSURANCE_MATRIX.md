...
- **Acceptance evidence**: The current full repository regression completed with `446 passed, 2 skipped, 4 warnings`; E12 managed-runtime probes also passed in the production image.
