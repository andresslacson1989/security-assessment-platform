...
- **Status:** VERIFIED for the non-escalation and explicit-admission boundaries; provider egress governance and credential injection remain pending capabilities.
