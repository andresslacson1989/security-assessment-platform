...
- **Status:** Repository controls are verified by the E13 assurance tests. Approved managed E13 runtimes are unavailable in the current environment: Semgrep `1.175.0` vs approved `1.65.0`, Bandit `1.9.4` vs approved `1.7.8`, Trivy `0.74.0` vs approved `0.50.0`, Gitleaks without an approved managed trust record, and TruffleHog/Retire.js/Grype/Syft/OSV-Scanner absent. No unmanaged runtime is treated as evidence. Focused assurance tests completed with `43 passed, 1 skipped`; full regression completed with `285 passed, 2 skipped, 4 warnings`.
